...
namespace Groc.Areas.Identity.Pages.Account.Manage
{
    public partial class IndexModel : PageModel
    {
        ...
        private async Task LoadAsync(GroceriesUser user)
        {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (Input.VillaNumber != user.VillaNumber)
            {
                user.VillaNumber = Input.VillaNumber;
            }
